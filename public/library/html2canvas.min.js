    ...
    ***************************************************************************** */ var r = function (A, e) {
        ...
        var e = (B = (function (A, r) {
                ...
                return (
                    A.forEach(function (A, e) {
                        var t = rA.get(A);
                        if ((50 < t ? (s.push(!0), (t -= 50)) : s.push(!1), -1 !== ["normal", "auto", "loose"].indexOf(r) && -1 !== [8208, 8211, 12316, 12448].indexOf(A)))
    ...
    var y,
        ...
        rA =
            ((m = (function (A) {
                ...
                for (
                    var n = new ("undefined" != typeof ArrayBuffer && "undefined" != typeof Uint8Array && void 0 !== Uint8Array.prototype.slice ? ArrayBuffer : Array)(n),
                ...
                for (;;) {
                    ...
                    if (CA(r))
                        return (
                            ...
                            -1 === this.peekCodePoint(0) || 41 === this.peekCodePoint(0) ? (this.consumeCodePoint(), { type: 22, value: g.apply(void 0, A) }) : (this.consumeBadUrlRemnants(), xA)
                        );
    ...
    function an(A, e, t, r, B, n) {
        ...
        for (var i = 0; 0 < s && i <= 4; i++) {
            ...
            0 == Q && Pt(n, 1) && "" !== o
                ? (o = e[Q] + o)
                : 1 < Q || (1 == Q && 0 === i) || (1 == Q && 1 === i && Pt(n, 2)) || (1 == Q && 1 === i && Pt(n, 4) && 100 < A) || (1 == Q && 1 < i && Pt(n, 8))
                ? (o = e[Q] + (0 < i ? t[i - 1] : "") + o)
                : 1 == Q && 0 < i && (o = t[i - 1] + o),
                (s = Math.floor(s / 10));
        }
    ...
    var gn,
        ...
        dn =
            ...
            (fn.prototype.createElementClone = function (A) {
                ...
                var e = A.cloneNode(!1);
                return (
                    $B(e) && ($B(A) && A.currentSrc && A.currentSrc !== A.src && ((e.src = A.currentSrc), (e.srcset = "")), "lazy" === e.loading && (e.loading = "eager")),
            ...
            (fn.prototype.appendChildNode = function (A, e, t) {
                (XB(e) && ("SCRIPT" === e.tagName || e.hasAttribute(hn) || ("function" == typeof this.options.ignoreElements && this.options.ignoreElements(e)))) ||
                                ...
                                if (0 === A.type) a.appendChild(Q.createTextNode(A.value));
                                    ...
                                    "attr" === A.name
                                        ...
                                        ? ((B = (r = A.values.filter($A))[0]),
                                          (r = r[1]),
                                          B && _A(B) && ((t = i.counters.getCounterValue(B.value)), (s = r && _A(r) ? pt.parse(i.context, r.value) : 3), a.appendChild(Q.createTextNode(Fn(t, s, !1)))))
                                        : "counters" === A.name &&
            ...
            fn);
    function fn(A, e, t) {
        if (((this.context = A), (this.options = t), (this.scrolledElements = []), (this.referenceElement = e), (this.counters = new Bn()), (this.quoteDepth = 0), !e.ownerDocument))
        ...
        es = function (A) {
            ...
            (this.topLeftBorderDoubleOuterBox = 0 < r || 0 < B ? ss(t.left + F / 3, t.top + l / 3, r - F / 3, B - l / 3, As.TOP_LEFT) : new Zn(t.left + F / 3, t.top + l / 3)),
                ...
                (this.topLeftBorderDoubleInnerBox =
                    0 < r || 0 < B ? ss(t.left + (2 * F) / 3, t.top + (2 * l) / 3, r - (2 * F) / 3, B - (2 * l) / 3, As.TOP_LEFT) : new Zn(t.left + (2 * F) / 3, t.top + (2 * l) / 3)),
                (this.topRightBorderDoubleInnerBox =
                    0 < r || 0 < B ? ss(t.left + a, t.top + (2 * l) / 3, n - (2 * C) / 3, s - (2 * l) / 3, As.TOP_RIGHT) : new Zn(t.left + t.width - (2 * C) / 3, t.top + (2 * l) / 3)),
                (this.bottomRightBorderDoubleInnerBox =
                    0 < o || 0 < i ? ss(t.left + w, t.top + g, o - (2 * C) / 3, i - (2 * u) / 3, As.BOTTOM_RIGHT) : new Zn(t.left + t.width - (2 * C) / 3, t.top + t.height - (2 * u) / 3)),
                (this.bottomLeftBorderDoubleInnerBox =
                    0 < Q || 0 < c ? ss(t.left + (2 * F) / 3, t.top + U, Q - (2 * F) / 3, c - (2 * u) / 3, As.BOTTOM_LEFT) : new Zn(t.left + (2 * F) / 3, t.top + t.height - (2 * u) / 3)),
                ...
                (this.bottomLeftPaddingBox =
                    0 < Q || 0 < c ? ss(t.left + F, t.top + Math.min(U, t.height - u), Math.max(0, Q - F), Math.max(0, c - u), As.BOTTOM_LEFT) : new Zn(t.left + F, t.top + t.height - u)),
                ...
                (this.bottomRightContentBox =
                    0 < o || 0 < i
                        ? ss(t.left + Math.min(w, t.width - (F + A)), t.top + Math.min(g, t.height + l + h), Math.max(0, o - (C + d)), i - (u + f), As.BOTTOM_RIGHT)
    ...
    function gs(A, e) {
        ...
        (this.container = A),
            ...
            0 !== this.container.styles.overflowX &&
                ((t = ts(this.curves)), (r = rs(this.curves)), ns(t, r) ? this.effects.push(new is(t, 6)) : (this.effects.push(new is(t, 2)), this.effects.push(new is(r, 4))));
    }
    function ws(A, e) {
        switch (e) {
            case 0:
                        ...
                        switch (A.label) {
                            ...
                            case 12:
                                return e instanceof vB && e.tree
                                    ? [4, new Ds(this.context, { scale: this.options.scale, backgroundColor: e.backgroundColor, x: 0, y: 0, width: e.width, height: e.height }).render(e.tree)]
                                    : [3, 14];
                            case 13:
                    ...
                    return H(this, function (A) {
                        return (
                            ...
                            B <= 2 * n
                                ...
                                : B <= 2 * n + s
                                ? ((n *= i = B / (2 * n + s)), (s *= i))
                                : ((Q = Math.floor((B + s) / (n + s))), (i = (B - Q * n) / (Q - 1)), (s = (Q = (B - (Q + 1) * n) / Q) <= 0 || Math.abs(s - i) < Math.abs(s - Q) ? i : Q)),
                            ...
                            2 === C &&
                                ($n(e[0]) && ((c = e[3]), (a = e[0]), this.ctx.beginPath(), this.formatPath([new Zn(c.end.x, c.end.y), new Zn(a.start.x, a.start.y)]), this.ctx.stroke()),
                                $n(e[1]) && ((c = e[1]), (a = e[2]), this.ctx.beginPath(), this.formatPath([new Zn(c.end.x, c.end.y), new Zn(a.start.x, a.start.y)]), this.ctx.stroke())),
                            this.ctx.restore(),
                            [2]
                        );
                    });
                            ...
                            case 0:
                                return (
                                    this.options.backgroundColor &&
                                        ((this.ctx.fillStyle = ie(this.options.backgroundColor)), this.ctx.fillRect(this.options.x, this.options.y, this.options.width, this.options.height)),
                                    (t = new as((e = B), null)),
                                    (r = new cs(t)),
                                    hs(t, r, r, (e = [])),
                                    ds(t.container, e),
            ...
            return a(void 0, void 0, void 0, function () {
                ...
                return H(this, function (A) {
                    switch (A.label) {
                        ...
                        case 5:
                            return (
                                (null !== (C = F.removeContainer) && void 0 !== C && !C) || dn.destroy(r) || g.logger.error("Cannot detach cloned iframe as it is not in the DOM anymore"),
